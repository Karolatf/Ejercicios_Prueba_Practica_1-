...
// Retorna: objeto con promedio y categoría de rendimiento
function calcularPromedio(notas) {
  ...
  // Validamos que todas las notas estén entre 0 y 5
  ...
  // Determinamos la categoría de rendimiento según rangos
  ...
  return {
    ...
    rendimiento,
    mensaje: `${emoji} Promedio: ${promedio.toFixed(2)} - Rendimiento: ${rendimiento}`
  };
}
